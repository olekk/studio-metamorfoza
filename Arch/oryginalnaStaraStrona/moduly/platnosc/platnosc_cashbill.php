...
if(!class_exists('platnosc_cashbill')) {
  class platnosc_cashbill {
    ...
    // class constructor
    function platnosc_cashbill( $parametry = array() ) {
    ...
    function podsumowanie() {
        ...
        $sign = md5 ( $this->paramatery['parametry']['PLATNOSC_CASHBILL_ID'].$zamowienie->info['wartosc_zamowienia_val'].$_SESSION['domyslnaWaluta']['kod'].'Numer zamowienia: ' . (int)$_SESSION['zamowienie_id'].$_SESSION['domyslnyJezyk']['kod'].$_SESSION['zamowienie_id'].
            $_SESSION['adresDostawy']['imie'].
            $_SESSION['adresDostawy']['nazwisko'].
        ...
        $parameters['desc']             = 'Numer zamowienia: ' . (int)$_SESSION['zamowienie_id'];
        $parameters['lang']             = $_SESSION['domyslnyJezyk']['kod'];
        $parameters['currency']         = $_SESSION['domyslnaWaluta']['kod'];
        $parameters['userdata']         = $_SESSION['zamowienie_id'];

        $parameters['forname']          = $_SESSION['adresDostawy']['imie'];
        $parameters['surname']          = $_SESSION['adresDostawy']['nazwisko'];
