...
$kod = str_replace( '{__TOKEN_LOGOWANIE}', Sesje::Token(), $kod );
$kod = str_replace( '{__TOKEN_LOGOWANIE_OKNO}', Sesje::Token(), $kod );
$kod = str_replace( '{__TOKEN_SPRAWDZENIE}', Sesje::Token(), $kod );
$kod = str_replace( '{__TOKEN_PRZYPOMNIENIE}', Sesje::Token(), $kod );
$kod = str_replace( '{__TOKEN_PRZYPOMNIENIE_OKNO}', Sesje::Token(), $kod );
