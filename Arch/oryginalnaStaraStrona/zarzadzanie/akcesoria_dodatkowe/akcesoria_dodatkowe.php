...
if ($prot->wyswietlStrone) {
    ...
    $zapytanie = "SELECT DISTINCT 
              ...
              RIGHT JOIN products_accesories s ON p.products_id = s.pacc_products_id_master " . $warunki_szukania;    
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            $tablica_naglowek[] = array('Nazwa produktu', '', 'width:50%');
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $zapytanie_powiazane = "select count(*) as ile_produktow from products_accesories where pacc_products_id_master = '".$info['products_id']."'";
                  ...
                  $tekst .= '<a href="akcesoria_dodatkowe/akcesoria_dodatkowe_edytuj.php'.$zmienne_do_przekazania.'"><img src="obrazki/edytuj.png" alt="Edytuj" title="Edytuj" /></a>'; 
                  $tekst .= '<a href="akcesoria_dodatkowe/akcesoria_dodatkowe_usun.php'.$zmienne_do_przekazania.'"><img src="obrazki/kasuj.png" alt="Skasuj" title="Skasuj" /></a>';
    ...
    if (!isset($_GET['parametr'])) { 
        ...
        <div id="caly_listing">
            ...
            <div id="naglowek_cont">Akcesoria dodatkowe</div>
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>             
            ...
            <a id="sort_a1" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a1">nazwy rosnąco</a>
            <a id="sort_a2" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a2">nazwy malejąco</a>
            <a id="sort_a3" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a3">nr katalogowy rosnąco</a>
            <a id="sort_a4" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a4">nr katalogowy malejąco</a>           
            <a id="sort_a5" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a5">aktywne</a>
            <a id="sort_a6" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a6">nieaktywne</a>              
            <a id="sort_a7" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a7">ID malejąco</a>
            <a id="sort_a8" class="sortowanie" href="akcesoria_dodatkowe/akcesoria_dodatkowe.php?sort=sort_a8">ID rosnąco</a>                
            </div>        
                        ...
                        <div class="okno_kateg">
                            ...
                            for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" title="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'akcesoria_dodatkowe\')" />' : '').'</td>
                                      </tr>
            ...
            <?php Listing::pokazAjax('akcesoria_dodatkowe/akcesoria_dodatkowe.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id'); ?>
            //]]>
            </script>              
