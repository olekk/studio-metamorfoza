                        ...
                        switch ((int)$_POST['akcja_dolna']) {
                            ...
                            case 7:
                                ...
                                if (!empty($info['star_date'])) {
                                    if (strtotime($info['star_date']) > time() && (strtotime($info['star_date']) + $wskaznikObliczenia) > time() ) {
                                         $pola = array(array('star_date',date('Y-m-d', strtotime($info['star_date']) + $wskaznikObliczenia)));
                                      } else {
                                         $pola = array(array('star_date','0000-00-00'));
                                    }
                                }
                            ...
                            case 8:
                                ...
                                if (!empty($info['star_date_end'])) {
                                    if (strtotime($info['star_date_end']) > time() && (strtotime($info['star_date_end']) + $wskaznikObliczenia) > time() ) {
                                         $pola = array(array('star_date_end',date('Y-m-d', strtotime($info['star_date_end']) + $wskaznikObliczenia)));
                                      } else {
                                         $pola = array(array('star_date_end','0000-00-00'));
                                    }
                                }
