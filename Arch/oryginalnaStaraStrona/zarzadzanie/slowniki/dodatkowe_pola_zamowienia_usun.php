...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        //			
        $db->delete_query('orders_extra_fields' , " fields_id = '".$filtr->process($_POST["id"])."'");
        $db->delete_query('orders_extra_fields_info' , " fields_id = '".$filtr->process($_POST["id"])."'");
        $db->delete_query('orders_to_extra_fields' , " fields_id = '".$filtr->process($_POST["id"])."'");
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <p>
                      ...
                      <?php
                      $sprawdzenie = "select fields_id from orders_to_extra_fields where fields_id = '" . $filtr->process((int)$_GET['id_poz']) . "'";
