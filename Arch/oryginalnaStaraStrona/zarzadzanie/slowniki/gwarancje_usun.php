...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('products_warranty' , " products_warranty_id = '".$filtr->process($_POST["id"])."'");  
        ...
        $db->update_query('products' , $pola, " products_warranty_products_id = '".$filtr->process((int)$_POST["id"])."'");
        //        
