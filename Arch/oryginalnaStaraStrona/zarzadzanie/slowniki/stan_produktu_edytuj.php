...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $pola = array(
                array('products_condition_default',$filtr->process((int)$_POST["domyslny"])),
        );
        //
        ...
        $db->delete_query('products_condition_description' , " products_condition_id = '".$filtr->process($_POST["id"])."'");        
        ...
        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
            ...
            //     
            $pola = array(
                    array('products_condition_id',$filtr->process($_POST["id"])),
    ...
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from products_condition where products_condition_id = '" . $filtr->process((int)$_GET['id_poz']) . "'";
                ...
                <div class="pozycja_edytowana">
                    ...
                    <div class="info_tab_content">
                        ...
                        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
                            ...
                            $zapytanie_jezyk = "select distinct * from products_condition_description where products_condition_id = '".$filtr->process((int)$_GET['id_poz'])."' and language_id = '" .$ile_jezykow[$w]['id']."'";
                            ...
                            <div id="info_tab_id_<?php echo $w; ?>" style="display:none;">
                                ...
                                <p>
                                   <?php if ($w == '0') { ?>
                                    ...
                                    <input type="text" name="nazwa_<?php echo $w; ?>" size="45" value="<?php echo $nazwa['products_condition_name']; ?>" id="nazwa_0" />
                                   <?php } else { ?>
                                    <label>Nazwa:</label>   
                                    <input type="text" name="nazwa_<?php echo $w; ?>" size="45" value="<?php echo $nazwa['products_condition_name']; ?>" />
                                   <?php } ?>
                                </p> 
