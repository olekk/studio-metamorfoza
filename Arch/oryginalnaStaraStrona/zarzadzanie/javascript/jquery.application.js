...
//    $('#searchable-form').multiSelect();
    ...
    $('#multipleHeaders').multiSelect({
      selectableHeader : '<h4>Lista wyboru</h4>',
      selectedHeader : '<h4>Wybrane pozycje</h4>'
    });
    
    $('#multipleHeaders1').multiSelect({
      selectableHeader : '<h4>Lista wyboru</h4>',
      selectedHeader : '<h4>Wybrane pozycje</h4>'
    });

    $('#multipleHeaders2').multiSelect({
      selectableHeader : '<h4>Lista wyboru</h4>',
      selectedHeader : '<h4>Wybrane pozycje</h4>'
    });

	$('#multipleHeadersEmptyWysylka').multiSelect({
      selectableHeader : '',
      selectedHeader : ''
    });
    
    $('#multipleHeadersEmptyPlatnosc').multiSelect({
      selectableHeader : '',
      selectedHeader : ''
    });
