...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		alignX:			        'right',	    // horizontal alignment for the tip relative to the mouse cursor or the target element ('right', 'center', 'left', 'inner-left', 'inner-right') - 'inner-*' matter if alignTo:'target'
		alignY:			        'top',		    // vertical alignment for the tip relative to the mouse cursor or the target element ('bottom', 'center', 'top', 'inner-bottom', 'inner-top') - 'inner-*' matter if alignTo:'target'
