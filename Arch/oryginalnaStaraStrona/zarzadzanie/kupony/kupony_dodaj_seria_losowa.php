          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <input type="hidden" name="akcja" value="zapisz" />
                    ...
                    <p>
                      <label class="required">Z ilu znaków ma mieć kupon ?</label>
                      <input type="text" name="liczba_znakow" id="liczba_znakow" value="" size="10" class="toolTipText" title="Wartość liczbowa powyżej 0, ilość znaków bez prefixu - tylko losowego kodu" />
                    </p>

                    <p>
                      <label class="required">Ile kuponów wygenerować ?</label>
                      <input type="text" name="ilosc_generowana" id="ilosc_generowana" value="" size="10" class="toolTipText" title="Wartość liczbowa powyżej 0" />
                    </p>                    
