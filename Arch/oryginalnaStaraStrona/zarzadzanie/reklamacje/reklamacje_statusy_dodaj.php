...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="reklamacje/reklamacje_statusy_dodaj.php" method="post" id="reklamacjaForm" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <p>
                  ...
                  <input name="kolor" class="color" style="-moz-box-shadow:none" value="474747" size="8" />                    
                </p>                 
