...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="reklamacje/reklamacje_statusy_komentarze_edytuj.php" method="post" id="reklamacjaForm" class="cmxform">          
                ...
                <div class="pozycja_edytowana">
                    ...
                    <div class="info_tab_content">
                        ...
                        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
                            ...
                            $zapytanie_jezyk = "select distinct * from standard_complaints_comments_description where comments_id = '".$filtr->process((int)$_GET['id_poz'])."' and languages_id = '" .$ile_jezykow[$w]['id']."'";
