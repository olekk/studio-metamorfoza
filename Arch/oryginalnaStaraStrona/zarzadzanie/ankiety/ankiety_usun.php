...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('poll' , " id_poll = '".$filtr->process($_POST["id"])."'");  
        $db->delete_query('poll_description' , " id_poll = '".$filtr->process($_POST["id"])."'");
        $db->delete_query('poll_field' , " id_poll = '".$filtr->process($_POST["id"])."'");
        //
