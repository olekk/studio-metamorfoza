...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        Funkcje::PrzekierowanieURL('polecane.php?id_poz='.$id_dodawanej_pozycji);
    }
                ...
                <table>
                    <tr>
                        <td style="vertical-align:top">    
                            ...
                            Wyszukaj produkt lub wybierz kategorię z której<br /> chcesz wybrać produkt do utworzenia<br /> produktu polecanego
                            </p>
                            ...
                            <div id="wynik_produktow_polecane" style="display:none"></div>     

                            <div class="info_content" style="padding-left:5px">                
                            
                                <div id="formi" style="display:none">
                                
                                    <span class="wynik_naglowek_dodanie">Ustaw parametry dodawanego produktu polecanego</span>
                                
                                    <p>
                                        <label>Data rozpoczęcia:</label>
                                        <input type="text" name="data_polecane_od" value="" size="20"  class="datepicker" />                                        
                                    </p>
                                    
                                    <p>
                                        <label>Data zakończenia:</label>
                                        <input type="text" name="data_polecane_do" value="" size="20" class="datepicker" />                                            
                                    </p>
