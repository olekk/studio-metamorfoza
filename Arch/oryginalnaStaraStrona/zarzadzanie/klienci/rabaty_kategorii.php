    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            $tablica_naglowek = array(array('ID','center'),
                                      ...
                                      array('Klient','center'),
                                      array('Kategoria','center', 'width:30%'));
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $wszystkie_kategorie = explode(',', $info['discount_categories_id']);
                  $wyswietl = '';
                  
                  foreach ( $wszystkie_kategorie as $kategoria ) {
                               
                      // jakie sa kategorie parent
                      $KatId = explode('_',Kategorie::SciezkaKategoriiId($kategoria));
                      
                      $pelna_sciezka_kategorii = '';
                      if (count($KatId) > 1) {
                          $pelna_sciezka_kategorii = '<span class="sciezkaKat">';
                          //
                      ...
                      if ( isset($TablicaKategorii[$kategoria]) ) {
                           $wyswietl .= $pelna_sciezka_kategorii . '<span class="nazKatProd">' . $TablicaKategorii[$kategoria]['text'] . '</span> <br />';
                      }
                  ...
                  $tekst .= '<a href="klienci/rabaty_kategorii_edytuj.php'.$zmienne_do_przekazania.'"><img src="obrazki/edytuj.png" alt="Edytuj" title="Edytuj" /></a>';
                  $tekst .= '<a href="klienci/rabaty_kategorii_usun.php'.$zmienne_do_przekazania.'"><img src="obrazki/kasuj.png" alt="Skasuj" title="Skasuj" /></a>';
        ...
        <div id="caly_listing">
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="klienci/rabaty_kategorii.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>                          
            ...
            <a id="sort_a5" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a5">grupa klientów malejąco</a>
            <a id="sort_a6" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a6">grupa klientów rosnąco</a>
