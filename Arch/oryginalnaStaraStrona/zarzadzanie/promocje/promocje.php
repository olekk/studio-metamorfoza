    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica[] = array(((Funkcje::czyNiePuste($info['specials_date'])) ? date('d-m-Y H:i',strtotime($info['specials_date'])) : '-'),'center','white-space:nowrap'); 

                  $tablica[] = array(((Funkcje::czyNiePuste($info['specials_date_end'])) ? date('d-m-Y H:i',strtotime($info['specials_date_end'])) : '-'),'center','white-space:nowrap');                     
                  ...
                  if ( ( ((strtotime($info['specials_date']) > time() && $info['specials_date'] != '0000-00-00 00:00:00') || (strtotime($info['specials_date_end']) < time() && $info['specials_date_end'] != '0000-00-00 00:00:00') ) && $info['specials_status'] == '1' ) || $info['specials_status'] == '0' ) {
                     $tablica[] = array('<img src="obrazki/aktywny_off.png" alt="Promocja" title="Ten produkt nie jest wyświetlany jako promocja" />','center');
                   } else {
                     $tablica[] = array('<img src="obrazki/aktywny_on.png" alt="Promocja" title="Ten produkt jest wyświetlany jako promocja" />','center');
                  }
                  ...
                  $tekst .= '<a href="promocje/promocje_edytuj.php'.$zmienne_do_przekazania.'"><img src="obrazki/edytuj.png" alt="Edytuj" title="Edytuj" /></a>'; 
                  $tekst .= '<a href="promocje/promocje_usun.php'.$zmienne_do_przekazania.'"><img src="obrazki/kasuj.png" alt="Skasuj" title="Skasuj" /></a>'; 
        ...
        <div id="caly_listing">
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="promocje/promocje.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>            
                        ...
                        <div class="okno_kateg">
                            ...
                            for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" title="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'promocje\')" />' : '').'</td>
                                      </tr>
                        ...
                        <div id="akcja">
                            ...
                            <div id="akc">
                                ...
                                <select name="akcja_dolna" id="akcja_dolna">
                                    ...
                                    <option value="9">zwiększ/zmniejsz ceny przekreślone o xx.xx <?php echo $domyslna_waluta['symbol']; ?></option>
                                    <option value="10">zwiększ/zmniejsz ceny przekreślone o xx.xx %</option>
                                </select>
                            </div>
                            <div style="clear:both;"></div>
                        </div>                          
            ...
            <?php Listing::pokazAjax('promocje/promocje.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id'); ?>
            //]]>
            </script>            
