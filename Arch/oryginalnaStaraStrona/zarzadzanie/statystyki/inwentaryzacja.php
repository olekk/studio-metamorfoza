                ...
                <div class="pozycja_edytowana">  
                    ...
                    <div id="wyszukaj" style="margin:10px">
                        ...
                        if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                          echo '<div id="wyszukaj_ikona"><a href="statystyki/inwentaryzacja.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                        }                             
                        ?>
                    ...
                    <div id="tryb_1" style="display:none">
                        <div id="drzewo" style="margin-left:10px">
                            ...
                            for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                                ...
                                echo '<tr>
                                        <td class="lfp">
                                            <a href="statystyki/inwentaryzacja.php?kategoria_id='.$tablica_kat[$w]['id'].'">'.$tablica_kat[$w]['text'].(($tablica_kat[$w]['status'] == 0) ? '<span class="wylKat toolTipTopText" title="Kategoria jest nieaktywna" /></span>' : '').'</a>
                                        </td>
                                        <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" title="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'inwentaryzacja\',\'statystyki\')" />' : '').'</td>
                                      </tr>
                    ...
                    $zapytanie = 'SELECT DISTINCT
                                  ...
                                  FROM products p, products_to_categories pc, products_description pd
                                  WHERE pd.products_id = p.products_id AND pc.products_id = p.products_id AND p.products_quantity > 0
                                         AND pd.language_id = "' . $_SESSION['domyslny_jezyk']['id'] . '" ' . $warunki_szukania . ' order by p.products_quantity, pd.products_name asc limit ' . $PoczatekLimit . ',' . $IleNaStronie;
                    ...
                    <div id="dolne_strony">
                        ...
                        for ($c = 0; $c < $limit; $c++) {
                            ...
                            //
                            if ($c == 0) {
                                echo '<a class="a_buts' . $Rozszerzenie . '" href="statystyki/inwentaryzacja.php">1</a>';
                              } else {
                                echo '<a class="a_buts' . $Rozszerzenie . '" href="statystyki/inwentaryzacja.php?str='.$c.'">' . ($c + 1) . '</a>';
                            }
                        }
                        //
