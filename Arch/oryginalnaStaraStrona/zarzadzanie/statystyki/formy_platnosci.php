            ...
            <div class="naglowek">Wybierane formy płatności</div>
                ...
                <div class="pozycja_edytowana">  
                    ...
                    if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                      echo '<div id="wyszukaj_ikona" style="margin-top:8px"><a href="statystyki/formy_platnosci.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                    }
                    ?>                     
                    ...
                    if ($SumaBylo == true) {
                        ...
                        {"data-file":"statystyki/formy_platnosci_wykres.php<?php echo $przekazGet; ?>"}, {"wmode" : "transparent"} );
                        </script>      
