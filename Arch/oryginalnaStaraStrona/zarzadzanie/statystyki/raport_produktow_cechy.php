            ...
            <div class="naglowek">Raport sprzedaży dla produktu w określonym przedziale czasowym w podziale na poszczególne cechy</div>
                ...
                <div class="pozycja_edytowana">  
                    ...
                    if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                      echo '<div id="wyszukaj_ikona" style="margin-top:8px"><a href="statystyki/raport_produktow_cechy.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" title="Anuluj wyszukiwanie" /></a></div>';
                    }
                    ?>                    
                    ...
                    if (isset($_GET['id_produkt']) && (int)$_GET['id_produkt'] > 0) {
                        ...
                        $zapytanie = "SELECT op.final_price_tax AS wartosc_brutto, 
                                       ...
                                       WHERE o.orders_id = op.orders_id AND 
                                             ...
                                             " . $warunki_szukania . "
                                    GROUP BY op.orders_products_id ORDER BY op.products_name, cechy";
