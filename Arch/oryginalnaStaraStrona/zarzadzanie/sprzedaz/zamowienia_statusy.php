    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  // kolor      
                  $tablica[] = array('<span class="status_zamowienia_kolor" style="background:#'.$info['orders_status_color'].'">&nbsp;</span>','center');                                   
                  ...
                  // domyslny
                  if ($info['orders_status_default'] == '1') { $obraz = '<img src="obrazki/aktywny_on.png" alt="Ten status jest domyślny" title="Ten status jest domyślny" />'; } else { $obraz = '-'; }              
                  ...
                  $tekst .= '<a href="sprzedaz/zamowienia_statusy_komentarze.php?status_id='.$info['orders_status_id'].'"><img src="obrazki/lista_wojewodztw.png" alt="Standardowe komentarze do zamówień" title="Standardowe komentarze do zamówień" /></a>';
                  $tekst .= '<a href="sprzedaz/zamowienia_statusy_edytuj.php'.$zmienne_do_przekazania.'"><img src="obrazki/edytuj.png" alt="Edytuj" title="Edytuj" /></a>';
                  if ( $info['orders_status_default'] != '1' ) {
                    $tekst .= '<a href="sprzedaz/zamowienia_statusy_usun.php'.$zmienne_do_przekazania.'"><img src="obrazki/kasuj.png" alt="Skasuj" title="Skasuj" /></a>';
                  } else {
