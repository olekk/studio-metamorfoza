          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
              <div class="info_content">
                ...
                <p>
                    <label>NIP:</label>
                    <input type="text" name="klient_nip" id="klient_nip" size="50" value="<?php echo $zamowienie->platnik['nip']; ?>" />
                    <label style="padding-left:20px;width:45px;">PESEL:</label>
                    <input type="text" name="klient_pesel" id="pesel" size="50" value="<?php echo $zamowienie->platnik['pesel']; ?>" />
                </p> 
                ...
                <p>
                  ...
                  <input type="radio" value="1" name="rozliczona" onclick="$('#data').slideUp()" /> tak
                  <input type="radio" value="0" name="rozliczona" onclick="$('#data').slideDown()" checked="checked" /> nie
                </p> 
              ...
              <div style="padding:10px;">
                <table cellpadding="0" cellspacing="0" style="width:100%" id="items">
                  ...
                  if ( $dostawa_cena_brutto > 0 ) {
                      ...
                      $dostawa_cena_netto           = $waluty->FormatujCeneBezSymbolu($dostawa_cena_brutto - ($dostawa_cena_brutto * ( $vat / ( 100 + $vat ) )));
                      $dostawa_wartosc_brutto       = $waluty->FormatujCeneBezSymbolu($dostawa_cena_brutto * 1);
                      $dostawa_wartosc_vat          = $waluty->FormatujCeneBezSymbolu($dostawa_wartosc_brutto * ( $vat / ( 100 + $vat ) ));
                  ...
                  <tr id="razem">
                      ...
                      <td class="faktura_produkt" style="text-align:center"></td>
                  ...
                  echo '<tr><td style="padding:4px;text-align:right" colspan="9">Do zapłaty</td><td style="text-align:right;padding:4px;"><input type="text" value="'.$waluty->FormatujCeneBezSymbolu($kwotaDoZaplaty).'" size="10" style="text-align:right;" name="total_rabat_brutto" id="total_rabat_brutto" /></td></tr>';
                  ?>
